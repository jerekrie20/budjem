            ...
            <nav class="bg-black dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
                        ...
                        <div class="flex">
                            ...
                            <div class="shrink-0 flex items-center">
                                <Link :href="route('dashboard')">
                                    <ApplicationLogo
                                        class="block h-24 w-auto fill-current text-white dark:text-gray-200"
                                    />
                                </Link>
                            </div>
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <NavLink :href="route('dashboard')" :active="route().current('dashboard')  ">
                                    <span class="dark:text-gray-200 text-white">Dashboard</span>
                                </NavLink>
                                <NavLink :href="route('budget')" :active="route().current('budget')">
                                    <span class="dark:text-gray-200 text-white">Budget</span>
                                </NavLink>
                            </div>
                ...
                >
                    <div class="pt-2 pb-3 space-y-1">
                        ...
                        <ResponsiveNavLink :href="route('graph')" :active="route().current('graph')">
                            Graph
                        </ResponsiveNavLink>
                    </div>
